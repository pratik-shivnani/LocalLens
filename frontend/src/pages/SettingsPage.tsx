    ...
    <div className="p-6 max-w-4xl mx-auto">
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="p-4 bg-gray-900/50 rounded-xl border border-gray-700/30">
              ...
              <div className="text-2xl font-bold text-white">{stats.total_photos.toLocaleString()}</div>
            </div>
            ...
            <div className="p-4 bg-gray-900/50 rounded-xl border border-gray-700/30">
              ...
              <div className="text-2xl font-bold text-white">{stats.total_videos.toLocaleString()}</div>
            </div>
            ...
            <div className="p-4 bg-gray-900/50 rounded-xl border border-gray-700/30">
              ...
              <div className="text-2xl font-bold text-white">{stats.total_people.toLocaleString()}</div>
            </div>
            ...
            <div className="p-4 bg-gray-900/50 rounded-xl border border-gray-700/30">
              ...
              <div className="text-2xl font-bold text-white">{stats.total_tags.toLocaleString()}</div>
            </div>
            ...
            <div className="p-4 bg-gray-900/50 rounded-xl border border-gray-700/30">
              ...
              <div className="text-2xl font-bold text-white">{formatBytes(stats.storage_size_bytes)}</div>
            </div>
      ...
      <div className="bg-gray-800/50 rounded-xl border border-gray-700/50 p-6 mb-6">
        ...
        <p className="text-gray-400 text-sm mb-4">
          Edit the <code className="bg-gray-700 px-2 py-0.5 rounded text-blue-400">.env</code> file in the backend directory to configure:
        </p>
        
        <div className="space-y-3 text-sm">
          <div className="p-3 bg-gray-900/50 rounded-xl border border-gray-700/30">
            <code className="font-mono text-blue-400">PHOTOS_LIBRARY_PATH</code>
            <p className="text-gray-500 mt-1">Path to your photos library</p>
          </div>
          <div className="p-3 bg-gray-900/50 rounded-xl border border-gray-700/30">
            <code className="font-mono text-blue-400">DEVICE</code>
            <p className="text-gray-500 mt-1">ML device: mps (Apple Silicon), cuda (NVIDIA), or cpu</p>
          </div>
          <div className="p-3 bg-gray-900/50 rounded-xl border border-gray-700/30">
            <code className="font-mono text-blue-400">BATCH_SIZE</code>
      ...
      <div className="bg-gray-800/50 rounded-xl border border-gray-700/50 p-6">
        ...
        <div className="text-sm text-gray-400 space-y-2">
          <p><strong className="text-white">LocalLens</strong> v1.0.0</p>
